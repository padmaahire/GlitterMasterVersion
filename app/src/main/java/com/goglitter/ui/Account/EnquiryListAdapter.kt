...
class EnquiryListAdapter(private var mList: ArrayList<ApplicationLeads>) : RecyclerView.Adapter<EnquiryListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.name.setText(ItemsViewModel.appName+" "+ItemsViewModel.appLname)
        holder.phone.setText(ItemsViewModel.appMobile)
        holder.email.setText(ItemsViewModel.appEmail)
    ...
    fun updateLeadList(LeadList: ArrayList<ApplicationLeads>) {
        mList = LeadList
